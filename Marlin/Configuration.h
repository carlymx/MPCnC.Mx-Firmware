...
#define STRING_CONFIG_H_AUTHOR "(none, SurfaceScan config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 XMAIL_URL         // will be shown during bootup in line 2
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // Y offset: -front +behind [the nozzle] (Default 10)		//***********************
