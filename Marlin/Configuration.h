...
#define STRING_CONFIG_H_AUTHOR "(carlymx@gmail.com)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CnC.aRLy v1.0"
...
#define USE_ZMAX_PLUG			// para escaneo de superficies ************************************
 ...
 */
#define FIX_MOUNTED_PROBE	//*************SELECCIONAN COMO SENSOR AUTOLEVEL UN INTERRUPTOR
...
#define XY_PROBE_SPEED 5000	//*********** 8000

// Feedrate (mm/m) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST 1000   //****************** HOMING_FEEDRATE_Z
...
#define AUTO_BED_LEVELING_BILINEAR		// SELECION TIPO DE AUTOLEVEL
